...
public class FetchAction extends RepoAction {
    ...
    private Dialog fetchDialog() {
        ...
        }).setNeutralButton(R.string.dialog_fetch_all_button,
            (dialogInterface, i) -> fetch(originRemotes)).setNegativeButton(android.R.string.cancel, new DummyDialogListener()).create();
    }
}
