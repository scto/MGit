package xyz.realms.mgit.delegate;

import xyz.realms.android.utils.FsUtils;
import xyz.realms.mgit.ui.RepoDetailActivity;
import xyz.realms.mgit.delegate.actions.AddAllAction;
import xyz.realms.mgit.delegate.actions.AddRemoteAction;
import xyz.realms.mgit.delegate.actions.CherryPickAction;
import xyz.realms.mgit.delegate.actions.CommitAction;
import xyz.realms.mgit.delegate.actions.CommitPushAction;
import xyz.realms.mgit.delegate.actions.ConfigAction;
import xyz.realms.mgit.delegate.actions.DeleteAction;
import xyz.realms.mgit.delegate.actions.DiffAction;
import xyz.realms.mgit.delegate.actions.FetchAction;
import xyz.realms.mgit.delegate.actions.MergeAction;
import xyz.realms.mgit.delegate.actions.NewBranchAction;
import xyz.realms.mgit.delegate.actions.NewDirAction;
import xyz.realms.mgit.delegate.actions.NewFileAction;
import xyz.realms.mgit.delegate.actions.PullAction;
import xyz.realms.mgit.delegate.actions.PushAction;
import xyz.realms.mgit.delegate.actions.RawConfigAction;
import xyz.realms.mgit.delegate.actions.RebaseAction;
import xyz.realms.mgit.delegate.actions.RemoveRemoteAction;
import xyz.realms.mgit.delegate.actions.RepoAction;
import xyz.realms.mgit.delegate.actions.ResetAction;
import xyz.realms.mgit.delegate.actions.UndoAction;
